<template>
	<div :style='{"padding":"30px calc((100% - 1200px)/2) 0","margin":"10px auto","alignItems":"flex-start","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
	...
	<div :style='{"width":"100%","overflow":"hidden","flexWrap":"wrap","background":"#fff","justifyContent":"space-between","display":"flex"}'>
		...
		<div :style='{"minHeight":"360px","border":"1px solid rgb(123, 123, 123)","padding":"30px 40px 0","alignItems":"flex-start","borderRadius":"10px","flexWrap":"wrap","background":"none","flex":"1","display":"flex","width":"calc(100% - 280px)","position":"relative","order":"2"}'>
		...
		<!-- option -->
		<div :style='{"padding":"0 0 0 280px","margin":"10px 0 0","display":"flex","width":"calc(100% - 0px)","justifyContent":"space-between","height":"auto","order":"10"}'>
		  <div :style='{"cursor":"pointer","margin":"0 50px 0 0","lineHeight":"40px","fontSize":"14px","color":"#999"}' @click="prepDetailClick">上一篇：prev</div>
		  <div :style='{"cursor":"pointer","lineHeight":"40px","fontSize":"14px","color":"#999"}' @click="nextDetailClick">下一篇：next</div>
		</div>

		<!-- 推荐文章 -->
		<div class="news" :style='{"border":"0px solid #e9e9e9","margin":"5px 20px 0 0","textAlign":"center","background":"#fff","width":"260px","height":"auto","order":"1"}'>
		  <div :style='{"padding":"0px 20px","color":"#fff","textAlign":"left","background":"rgb(22, 159, 25)","display":"inline-block","width":"100%","lineHeight":"43px","fontSize":"18px"}'>推荐文章</div>
		  <div :style='{"padding":"0","margin":"0","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		    <div v-for="item in recommendList" :key="item.id" :style='{"cursor":"pointer","width":"100%","background":"#fff","height":"auto"}' @click="toDetail(item.id)">
