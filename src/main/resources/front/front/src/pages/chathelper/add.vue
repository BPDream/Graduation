...
<div :style='{"width":"100%","padding":"30px calc((100% - 1200px)/2) 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    <el-form
      ...
      label-width="180px"
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="提问" prop="ask">
            <el-input v-model="ruleForm.ask" 
                placeholder="提问" clearable :disabled=" false  ||ro.ask"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="回复" prop="reply">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="回复"
